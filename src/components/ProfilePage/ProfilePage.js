        ...
        <div className="px-4 py-16 items-end mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="grid grid-cols-2">
                <div className="grid grid-cols-1 gap-4 max-w-screen-sm items-center text-left space-x-4 mb-5">
                    ...
                    <div className="space-y-1 font-medium text-gray-800">
                        <div className="text-lg text-gray-400">Администратор</div>
                        <div className="text-2xl">AdminName AdminLastname</div>
                    </div>
                    <div className="mt-5 space-y-1 font-medium text-gray-800">
                        <div className="text-base text-gray-400">Имя пользователя</div>
                        <div className="text-xl">admin</div>
                    </div>
                    <div className="space-y-1 font-medium text-gray-800">
                        <div className="text-base text-gray-400">Почта</div>
                        <div className="text-xl">admin@admin.mint.ru</div>
                    </div>
                    <div className="pt-3">
                        <button type="button"
